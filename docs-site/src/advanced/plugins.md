...
For a practical authoring walkthrough, see [Plugin Development](/advanced/plugin-development). For the
production runtime boundary, see [Extension Host](/advanced/extension-host).
